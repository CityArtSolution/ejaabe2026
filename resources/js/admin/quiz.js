(function ($) {
    ...
    $('body').on('click', '#add_eval_category', function (e) {
    e.preventDefault();
    var quizId = $(this).attr('data-quiz-id');
    var evalCategoryModal = $('.evalCategoryModal' + quizId);
    var clone = evalCategoryModal.clone();
   ...
   $('body').on('click', '.save-evalcategory', function (e) {
    e.preventDefault();
    var $this = $(this);
    var form = $this.closest('.eval-category-form');
