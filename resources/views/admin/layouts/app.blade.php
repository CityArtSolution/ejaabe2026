...
.main-sidebar .sidebar-menu li a span,.form-group label,strong,p,a,h1,h2,h3,h4,h5,h6{
    ...
    $('#summernote').summernote({
        callbacks: {
            onInit: function() {
                ...
                $('.note-editable').css('padding-top', '0px');
            },
            onPaste: function(e) {
                var bufferText = ((e.originalEvent || e).clipboardData || window.clipboardData).getData('Text');
                e.preventDefault();
                
                // Convert to plain text and remove extra formatting
