    ...
    <div class="js-form" data-action="{{ getAdminPanelUrl() }}/webinar-extra-description/store">
        ...
        <div class="js-form-groups">
            ...
            <div class="js-no-company-input form-group">
                ...
                <input type="text" name="link" class="js-ajax-link form-control"/>
                <div class="invalid-feedback"></div>
            </div>

            <!-- Add Attached File Field -->
            <div class="js-no-company-input form-group">
                <label class="input-label">{{ trans('public.attached') }}</label>
                <input type="file" name="attached" class="js-ajax-attached form-control"/>
                <div class="invalid-feedback"></div>
            </div>
        </div>
