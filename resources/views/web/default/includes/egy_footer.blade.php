                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="mt-20 footer-links" style="    font-weight: 500;">
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/egy/policy" target="_blank" class="text-decoration-none">{{ __('footer.privacy_policies') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/egy/alaltzam-bhkok-almlky-alfkry" target="_blank" class="text-decoration-none">{{ __('footer.commitment_ipr') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/egy/support-policy" target="_blank" class="text-decoration-none">{{ __('footer.support_policy') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/egy/nazaha-policy" target="_blank" class="text-decoration-none">{{ __('footer.academic_integrity') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/egy/syas-alhdor-alaftrady" target="_blank" class="text-decoration-none">{{ __('footer.virtual_attendance') }}</a>
                                </p>
                            </div>
                        </div>
                    @elseif($column == 'second_column')
                        <div class="col-md-2 col-sm-6" style="    font-weight: 500;color: #12669f !important;">
                            ...
                            <div class="mt-20 footer-links">
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/egy/classes?sort=newest" target="_blank" class="text-decoration-none">{{ __('footer.courses') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/aboutUs/egy" target="_blank" class="text-decoration-none">{{ __('footer.about_us') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/contactusEgy" target="_blank" class="text-decoration-none">{{ __('footer.contact_us') }}</a>
                                </p>
