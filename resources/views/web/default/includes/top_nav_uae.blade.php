...
<div class="top-navbar d-flex border-bottom">
            ...
            <div class="d-flex align-items-center justify-content-between justify-content-md-center">
                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center flex-row">
                    ...
                    <li class="d-flex align-items-center text-dark-blue font-14">
                            <i class="fa fa-envelope mr-5" aria-hidden="true"></i> info-UAE@ejaabi.com
                    </li>
                </ul>
            </div>
        </div>
  ...
  <div class="current-branch">
       <img style="width: 16px;margin: 6px;" src="/flags/ae.png" alt="AE"> {{ __('navbar.uae') }}
  </div>
  <ul>
    <li>
      <a href="/">
...
<script>
  ...
  dropdown.querySelector(".current-branch").addEventListener("click", () => {
    dropdown.classList.toggle("active");
            ...
            <div class="d-flex">
                @include(getTemplate().'.includes.shopping-cart-dropdwon_uae')
