...
@section('content')
   <section class="cart-banner position-relative text-center">
    ...
    <section class="home-sections position-relative">
        <div data-anim-wrap="" class="container animated">
            <div class="row y-gap-50 justify-between items-center">
                <div class="col-lg-8  sm:pr-15">
                    <h2>{{ __("app.title_about_jor") }}</h2>
                    <div class="composition -type-8">
                        <p class="text-dark-1 mt-30">{{ __("app.title_des_about_jor") }}</p>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row y-gap-50 justify-between items-center">
            ...
            <div class="col-lg-5">
                <br>
                <h2 class="text-30 lh-16">{{ __("app.some_dec") }}</h2>
                <p class="text-dark-1 mt-30">{{ __("app.some_dec_content") }}</p>
            </div>
        </div>
    </div>
    </section>
   ...
   <section class="home-sections container">
        <div class="text-center my-40">
            <div class="about-decor my-40 text-center">
                <h2 class="about-title">{{__("app.about")}}</h2>
                <div class="about-line">
                    <span></span>
                    <i class="fas fa-star-of-life"></i> 
                    <span></span>
                </div>
                <p class="about-hint">{{__("app.best")}}</p>
            </div>
        </div>
            ...
            <div class="solution_cards_box">
              <div class="solution_card">
                    ...
                    <g>
                      <g>
                        <g>
                          <g>
                            <div class="icon">
                                <i style="font-size:39px" class="flaticon-hr"></i>
                            </div>
                          </g>
                          <g>
                            <g>
                ...
                <div class="solu_title">
                  <h1 style="text-align:center;margin:11px 0;">{{__("app.Our Vision")}}</h1>
                </div>
                <div class="solu_description">
                  <p>
                    {{__("app.Our Vision content")}}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="our_solution_category">
            <div class="solution_cards_box">
              <div class="solution_card">
                ...
                <div class="so_top_icon">
                    <div class="icon">
                        <i style="font-size:39px" class="flaticon-value"></i>
                    </div>
                    <g>
                      <g>
                        <g>
                ...
                <div class="solu_title">
                  <h1 style="text-align:center;margin:11px 0;">{{__("app.Our Values")}}</h1>
                </div>
                <div class="solu_description">
                  <p>
                    <p>{{ trans('app.responsibility') }}</p> <br>
                    <p>{{ trans('app.innovation') }}</p> <br>
                    <p>{{ trans('app.commitment') }}</p> <br>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="our_solution_category">
            <div class="solution_cards_box">
              <div class="solution_card">
                ...
                <div class="so_top_icon">
                    <div class="icon">
                        <i style="font-size:39px" class="flaticon-start"></i>
                    </div>
                    <g>
                      <g>
                        <g>
                ...
                <div class="solu_title">
                  <h1 style="text-align:center;margin:11px 0;">{{ trans('app.mission_title') }}</h1>
                </div>
                <div class="solu_description">
                  <p>
                    {{ trans('app.mission_text') }}
                  </p>
                </div>
              </div>
            </div>
...
<section class="home-sections container" style="margin-top: 140px !important">
    <div class="text-center my-40">
        <div>
            <h2 class="section-title" style="color: black;">{{trans('app.comapny')}} </h2>
                    <div class="about-line">
                    <span></span>
                    <i class="fas fa-star-of-life"></i> 
                    <span></span>
...
<div class="position-relative home-sections testimonials-container">
        ...
        <section class="home-sections container">
            <div class="text-center my-40">
                <div>
                    <h2 class="section-title" style="color:black">{{ trans('app.clients') }} </h2>
                    <div class="about-line">
                        <span></span>
                        <i class="fas fa-star-of-life"></i> 
                        <span></span>
