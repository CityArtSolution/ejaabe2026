...
@else
 ...
 <ul class="ul_user">
                            <li class="ul_user_li">
                          <div class="info">
                                    <span>  <a href="/login" class="py-5 px-10 mr-10 text-dark-blue font-14">{{ trans('auth.login') }}</a>  </span>
                                </div>
                            </li>
                            <li>
                                
                                <div class="info">
                                    <span> <a href="/register" class="py-5 px-10 text-dark-blue font-14">{{ trans('auth.register') }}</a></span> 
                                </div>
                            </li>
