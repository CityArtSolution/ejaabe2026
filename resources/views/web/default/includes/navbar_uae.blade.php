...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light">
    <div class="{{ (!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container'}}">
        ...
        <a class="navbar-order d-flex align-items-center justify-content-center mr-0 {{ (empty($navBtnUrl) and empty($navBtnText)) ? 'ml-auto' : '' }}" href="/{{ app()->getLocale() }}/uae" style="padding-top:20px; padding-bottom:20px;">
        ...
        <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content" id="navbarContent">
            <div class="navbar-toggle-header text-right d-lg-none">
                ...
                <ul class="navbar-nav m-auto d-flex align-items-center">
                    <li class="nav-item">
                        <a class="nav-link" style="text-decoration-line: none !important;"href="/{{ app()->getLocale() }}/uae">{{ trans('navigation.home') }}</a>
                    </li>
                      <li class="nav-item">
                        <a class="nav-link" style="text-decoration-line: none !important;"href="/{{ app()->getLocale() }}/aboutUs/uae">{{ trans('navigation.about_us') }}</a>
                    </li>
                    
                    <li class="nav-item">
                        <lable class="nav-link">{{ __('navigation.servicse') }}</lable>
                        <div>
                        <a class="nav-link" style="text-decoration-line: none !important;"href="/{{ app()->getLocale() }}/uae/classes?sort=newest">{{ trans('navigation.training') }}</a>
                        <a class="nav-link" style="text-decoration-line: none !important;"href="/{{ app()->getLocale() }}/cet-course/plan/uae">{{ trans('navigation.TrainingProgramsPlan2025') }}</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" style="text-decoration-line: none !important;"href="">{{ trans('navigation.international_certificates') }}</a>
                    </li>
                  <li class="nav-item">
                        <a class="nav-link" style="text-decoration-line: none !important;"href="/{{ app()->getLocale() }}/contactusUae">{{ trans('navigation.contact_us') }}</a>
                    </li>
                </ul>
{{-- User Menu --}}
            @include('web.default.includes.top_nav.user_menu_uae')
        </div>
