                ...
                @if(!empty($footerColumns[$column]))
                    ...
                    @if($column != 'second_column' && $column != 'third_column' && $column != 'forth_column')
                        <div class="col-md-3 col-sm-6">
                            <span class="header d-block font-weight-bold mt-20 mb-3" style="color: #12669f !important;">{{ __('footer.policies') }}</span>
                            <div class="mt-20 footer-links" style="    font-weight: 500;">
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/uae/policy" target="_blank" class="text-decoration-none">{{ __('footer.privacy_policies') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/uae/alaltzam-bhkok-almlky-alfkry" target="_blank" class="text-decoration-none">{{ __('footer.commitment_ipr') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/uae/support-policy" target="_blank" class="text-decoration-none">{{ __('footer.support_policy') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/uae/nazaha-policy" target="_blank" class="text-decoration-none">{{ __('footer.academic_integrity') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/pages/uae/syas-alhdor-alaftrady" target="_blank" class="text-decoration-none">{{ __('footer.virtual_attendance') }}</a>
                                </p>
                            </div>
                        </div>
                    @elseif($column == 'second_column')
                        <div class="col-md-2 col-sm-6" style="    font-weight: 500;color: #12669f !important;">
                            <span class="header d-block font-weight-bold mt-20 mb-3" style="color: #12669f !important;">{{ __('footer.company_info') }}</span>
                            <div class="mt-20 footer-links">
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/uae/classes?sort=newest" target="_blank" class="text-decoration-none">{{ __('footer.courses') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/aboutUs/uae" target="_blank" class="text-decoration-none">{{ __('footer.about_us') }}</a>
                                </p>
                                <p style="line-height: 23px;">
                                    <a style="color:#4f547b;" href="/{{ app()->getLocale() }}/contactusUae" target="_blank" class="text-decoration-none">{{ __('footer.contact_us') }}</a>
                                </p>
                    ...
                    @elseif($column == 'third_column')
                        <div class="col-md-2 col-sm-6" style="text-align: center;">
                            @if(!empty($footerColumns[$column]['title']))
                                <span class="header d-block  font-weight-bold " style="color: #12669f !important; color: #12669f !important;margin: 20px 0;text-align: justify;">{{ __('footer.blogs_news') }}</span>
                            @endif
                    ...
                    @elseif($column == 'forth_column')
                        ...
                        <hr style="margin-top: 16px;margin-bottom: 16px;border: 0;border-top: 1px solid #4f547b">
                            <!-- Social -->
