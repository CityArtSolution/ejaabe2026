    ...
    <figure>
        ...
        <figcaption class="webinar-card-body">
            ...
            @if(!empty($upcomingCourse->category))
                <span class="d-block font-14 mt-10">{{ trans('public.in') }} <a href="{{ '/'.app()->getLocale().$upcomingCourse->category->getUrl() }}" target="_blank" class="text-decoration-underline">{{ $upcomingCourse->category->title }}</a></span>
            @endif
            ...
            <div class="webinar-price-box mt-25">
                ...
                @else
                  @if($upcomingCourse->type!='text_lesson' || $upcomingCourse->type!='course')
