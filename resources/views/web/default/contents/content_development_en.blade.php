...
@push('styles_top')
    <link rel="shortcut icon" href="/contents/en/files/8JG4xYcXxW3j8ptNE1xD.png" type="image/x-icon">


    <link rel="stylesheet" href="/contents/en/files/meanmenu.css">
    <link rel="stylesheet" href="/contents/en/files/magnific-popup.css">
    <link rel="stylesheet" href="/contents/en/files/animate.css">

    <link rel="stylesheet" href="/contents/en/files/style.css">
    ...
    <main>
        <div class="banner-three-area">
            <div class="banner-three__bg">
                <img class="sway_Y__animation" src="/contents/en/files/eYXIYYvGq4j0T5lsKJee.png" alt="bg-image">
            </div>
                    ...
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="banner-three__content pt-0 pb-0">
                            ...
                            <p class="wow fadeInUp mt-20" data-wow-delay="400ms" data-wow-duration="1500ms"
                                ...
                                In the context of the rapid developments in educational technology that the world is
                                witnessing. Positive Interaction for Training and Consulting, which has a content
                                development license from the National Center for E-Learning, is committed to producing and
                                developing practical and appropriate solutions for producing interactive digital educational
                                content for academic and training courses in an innovative digital form that complies with
                                international standards for e-learning. The courses prepared and developed by the Positive
                                Interaction team are distinguished by their compatibility with all computers, smart devices
                                and various operating systems (iOS/Android), while ensuring the compatibility of digital
                                content with XAPI & SCORM File standards and providing technical support for publishing on
                                                            ...
                                                            <div class="about-three__left-item">
                                                             <div class="section-header mb-40">
                                                              <h3 class="wow fadeInUp arrow-heading" data-wow-delay="00ms" data-wow-duration="1500ms">
                                                               <img class="me-1" src="/contents/en/files/2w2YVw3fQ3oiAXA1JE1u.png" alt="icon">
                                                               المقدمة
                                                              </h3>
                                                           ...
                                                           <div class="col-lg-5 order-1 order-lg-2">
                                                            <div class="faq__image about-three__image image wow fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInRight;">
                                                             <div class="about-three-dot">
                                                              <img class="sway__animationX" src="/contents/en/files/jlk9SbvrzRdSnaROyQgl.png" alt="shape">
                                                             </div>

                                                             <div class="faq__line sway__animation">
                                                              <img src="/contents/en/files/AR4qBRWmgCOWHac7I0BQ.png" alt="image">
                                                             </div>
                                                             <img src="/contents/en/files/elearning-1.png" alt="image">
                                                            </div>
                                                           </div>
                                                          </div>
                                                         </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay="3ms" data-wow-duration="1500ms"
                        ...
                        <div class="process__item mb-100">
                            <div class="process-arry bobble__animation">
                                <img src="/contents/en/files/WrStCRmXhumtuglrWmRZ.png" alt="arry-icon">
                            </div>
                            <div class="process__image">
                                <img src="/contents/en/files/2gpOZdFMiwfrgPmuYChB.png" alt="image">
                            ...
                            <div class="process__content">
                                ...
                                <p>
                                    Our content creation service involves close collaboration with subject matter experts to
                                    develop high-quality educational content. We work meticulously to design materials that
                                    align with the specified learning objectives, ensuring accuracy, comprehensiveness, and
                                    adaptability to the specific goals of the curriculum or training program.
                    ...
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay="6ms" data-wow-duration="1500ms"
                        ...
                        <div class="process__item mb-100">
                            ...
                            <div class="process__image">
                                <img src="/contents/en/files/p2V9aBo2Yv5EG9WGL2Rq.png" alt="image">
                            ...
                            <div class="process__content">
                                ...
                                <p>Creating engaging and interactive digital content that is organized and effective:
                                    Aligned with the latest local and global educational standards. Our team specializes in
                                    developing Arabic content for schools, universities, and corporate training. We follow
                                    the ADDIE model (Analysis, Design, Development, Implementation, and Evaluation) to
                                    ensure a comprehensive process.
                    ...
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay="8ms" data-wow-duration="1500ms"
                        ...
                        <div class="process__item mb-100">
                            ...
                            <div class="process__image">
                                <img src="/contents/en/files/lJ3iiIyqCvgZ3ccwF8Sl.png" alt="image">
                            ...
                            <div class="process__content">
                                ...
                                <p>
                                    Delivering a dynamic learning experience through 3D animations, making education more
                                    interactive and effective. This option is ideal for e-learning modules, corporate
                                    training programs, and immersive educational experiences.
                    ...
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay="8ms" data-wow-duration="1500ms"
                        ...
                        <div class="process__item mb-100">
                            ...
                            <div class="process__image">
                                <img src="/contents/en/files/e-learning-courses.png" alt="image">
                            ...
                            <div class="process__content">
                                ...
                                <p>
                                    We design innovative curricula that meet the needs of today's learners. We work closely
                                    with educators to create interactive, engaging, and effective content that enhances the
                                    learning experience and helps achieve their educational goals.
                                                           ...
                                                           <div class="col-lg-12">
                                                            <ul class="timeline">
                                                                       ...
                                                                       <div class="timeline-image">
                                                                        <img class="rounded-circle img-fluid" src="/contents/en/files/Picture2.png" alt="Service image">
                                                               </div>
            ...
            <div class="container">
                <div class="section-header text-center mb-60">
                    <h3 class="wow fadeInUp arrow-heading" data-wow-delay="00ms" data-wow-duration="1500ms"
                        ...
                        <img class="me-1" src="/contents/en/files/ceExPRVyCQvC5bMf6Qcc.png" alt="icon">
                        Team Members
                ...
                <div class="row g-4">
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms"
                        ...
                        <div class="service-three__item">
                            <div class="service-three__image image">
                                <img class="component-service-cover" src="/contents/en/files/J4yUHPfUIZqCEtkDzHqu.jpg"
                                    alt="image">
                            </div>
                            <div class="service-three__content">
                                <div class="icon">
                                    <img src="/contents/en/files/dVv1mnNVsvbsGeYuNNMb.png" alt="icon">
                                </div>
                                <h4>Content Experts
                                </h4>
                            </div>
                            <div class="service-three__up-content text-center">
                                <div class="icon">
                                    <img src="/contents/en/files/M2HVz79GkCeRn6OprjXj.png" alt="icon">
                                </div>

                                <p class="text-white">Reviewing, developing, and delivering scientific content and
                                    educational materials (if available), as well as creating content upon request by the
                                    learning center.
                                    .</p>
                    ...
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms"
                        ...
                        <div class="service-three__item">
                            <div class="service-three__image image">
                                <img class="component-service-cover" src="/contents/en/files/Z9sDx8bUcSl5gPy2SLwt.jpg"
                                    alt="image">
                            </div>
                            <div class="service-three__content">
                                <div class="icon">
                                    <img src="/contents/en/files/Jkj7MP3vEDmcWlm7wayO.png" alt="icon">
                                </div>
                                <h4>Technical Experts
                                </h4>
                            </div>
                            <div class="service-three__up-content text-center">
                                <div class="icon">
                                    <img src="/contents/en/files/7PcBBBTRtqoelANe30cp.png" alt="icon">
                                </div>

                                <p class="text-white">Responsible for the technical aspect, including programming and
                                    integration with the online platform.
                                </p>
                    ...
                    <div class="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms"
                        ...
                        <div class="service-three__item">
                            <div class="service-three__image image">
                                <img class="component-service-cover" src="/contents/en/files/jUNS23DkyVa2JtgsQpE5.jpg"
                                    alt="image">
                            </div>
                            <div class="service-three__content">
                                <div class="icon">
                                    <img src="/contents/en/files/ZJBdpAnZAspkWn0Mmw12.png" alt="icon">
                                </div>
                                <h4>Instructional Design Experts
                                </h4>
                            </div>
                            <div class="service-three__up-content text-center">
                                <div class="icon">
                                    <img src="/contents/en/files/BHXCvBiGAI8DcqJyh3XF.png" alt="icon">
                                </div>

                                <p class="text-white">Responsible for instructional design and ensuring that programs align
                                    with the best interactive learning methodologies.
                                </p>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="300ms"
                        ...
                        <div class="blog__item">
                            ...
                            <div class="blog__content">
                                <p>
                                    Each expert works in an integrated manner to ensure the achievement of project goals.

                                    The content expert provides the necessary materials.
                                    The instructional design expert designs the learning experience.
                                    The technical expert ensures that the content is effectively and securely displayed on
                                    the platform.
                                    Collaboration among these experts guarantees the delivery of high-quality educational
                                    programs.
    ...
    padding-left: 0;">
                    ...
                    <div class="col-lg wow fadeInUp">
                        <div class="card card-1 h-100 p-4">
                            <div class="card-number number-1" data-wow-delay="00ms" data-wow-duration="1500ms"
                                style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                1</div>
                            <h5 class="card-title">Performance Quality</h5>
                            <p class="card-text">Ensuring the delivery of high-quality services that comply with the
                                contract's specified standards and provide an outstanding learning experience.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg wow fadeInUp">
                        <div class="card card-2 h-100 p-4">
                            <div class="card-number number-2" data-wow-delay="00ms" data-wow-duration="1500ms"
                                style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                                2</div>
                            <h5 class="card-title">Advanced Design Approach</h5>
                            <p class="card-text">Offering various levels of content where educational programs are designed
                                using a diverse range of media to ensure a comprehensive learning experience.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg wow fadeInUp">
                        <div class="card card-3 h-100 p-4 text-white">
                            ...
                            <h5 class="card-title">Continuous Support</h5>
                            <p class="card-text">Providing ongoing technical and educational support throughout the project
                                duration to ensure the continuity and efficiency of operations.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg wow fadeInUp">
                        <div class="card card-4 h-100 p-4 text-white">
                            ...
                            <h5 class="card-title">Effective Project Management</h5>
                            <p class="card-text">Using project management methodologies while adhering to the agreed
                                timeline and standards, along with providing periodic reports to the Educational
                                Partnerships Manager at the Learning Center.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg wow fadeInUp">
                        <div class="card card-5 h-100 p-4 text-white">
                            ...
                            <h5 class="card-title">Integrated Interactive Design</h5>
                            <p class="card-text">Delivering a rich learning experience through a modern learning platform
                                that incorporates graphics, images, sounds, and videos to enhance learners' understanding
                                and increase engagement with the content.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="section-header mb-40">
                            ...
                            <h4 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"
                                ...
                                More information about the advanced design method. </h4>
                        ...
                        <div class="about-two__right-item wow fadeInDown" data-wow-delay="200ms"
                            ...
                            <ul>
                                <li class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"
                                    style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInUp;">
                                    <i class="fa-solid fa-check"></i> Educational videos: Producing professional
                                    educational videos that cover the content clearly and attractively.
                                </li>
                                <li class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms"
                                    style="visibility: visible; animation-duration: 1600ms; animation-delay: 230ms; animation-name: fadeInUp;">
                                    <i class="fa-solid fa-check"></i>Infographics: Using graphic designs to simplify and
                                    clarify important information in an easy-to-understand visual way.
                                </li>
                            </ul>
                            <ul>
                                <li class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1700ms"
                                    ...
                                    <i class="fa-solid fa-check"></i>Interactive courses: Developing interactive training
                                    courses that rely on the active participation of participants through interactive
                                    learning activities, such as simulations and instant quizzes.
                                </li>
        ...
        <section class="offer-area secondary-bg pt-120 pb-200">
            <div class="offer__shadow wow fadeIn" data-wow-delay="200ms" data-wow-duration="1500ms"
                ...
                <img src="/contents/en/files/9XOjHQrBVZpehzZP1Dqx.png" alt="shadow">
            </div>
            <div class="offer__shape-left">
                <img class="wow fadeInUpBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="/contents/en/files/frcJyZBV6mi916YfgDSS.png" alt="shape"
            ...
            <div class="offer__shape-right">
                <img class="wow fadeInDownBig" data-wow-delay="400ms" data-wow-duration="1500ms"
                    src="/contents/en/files/WRBtw8ujtjk4WjxLlKDn.png" alt="shape"
                ...
                <div class="row g-4">
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="100ms"
                        ...
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="/contents/en/files/MlVijCQNiCKS2NGGEbeC.png" alt="shape">
                            </div>
                            <div class="shape-bottom">
                                <img src="/contents/en/files/n07PzEIPOgnpJYoJIv1c.png" alt="shape">
                            </div>
                            <div class="offer__icon">
                                <img src="/contents/en/files/d1ZH2JKTVSJwEzbierK7.svg" alt="icon">
                            </div>
                            <a href="https://www.ejaabi.com/ar/pages/model2" target=_blank>
                                <h4 class="text-white mt-20"> Video and Animation Presenter
                                </h4>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="300ms"
                        ...
                        <div class="offer__item">
                            <div class="shape-top">
                                <img src="/contents/en/files/VS1MMf2b4SmC5al0R50j.png" alt="shape">
                            </div>
                            <div class="shape-bottom">
                                <img src="/contents/en/files/kq4tbOciNJOpIPvIEP8V.png" alt="shape">
                            </div>
                            <div class="offer__icon">
                                <img src="/contents/en/files/d1ZH2JKTVSJwEzbierK7.svg" alt="icon">
                            </div>
                            <a href="https://www.ejaabi.com/ar/pages/model4" target=_blank>
                                <h4 class="text-white mt-20"> Interactive E-Learning
                                </h4>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6 wow bounceInUp" data-wow-delay="400ms"
                        ...
                        <div class="offer__item">
                            ...
                            <div class="shape-bottom">
                                <img src="/contents/en/files/8EuV0x9GotNJLGKna1n4.png" alt="shape">
                            </div>
                            <div class="offer__icon">
                                <img src="/contents/en/files/d1ZH2JKTVSJwEzbierK7.svg" alt="icon">
                            </div>
...
@push('scripts_bottom')
    {{-- <script src="/contents/en/files/jquery-3.7.1.min.js"></script> --}}
    <script src="/contents/en/files/bootstrap.min.js"></script>
    <script src="/contents/en/files/meanmenu.js"></script>
    <script src="/contents/en/files/swiper-bundle.min.js"></script>
    <script src="/contents/en/files/jquery.counterup.min.js"></script>
    <script src="/contents/en/files/wow.min.js"></script>
    <script src="/contents/en/files/pace.min.js"></script>
    <script src="/contents/en/files/magnific-popup.min.js"></script>
    <script src="/contents/en/files/nice-select.min.js"></script>
    <script src="/contents/en/files/isotope.pkgd.min.js"></script>
    <script src="/contents/en/files/jquery.waypoints.js"></script>
    <script>
        'use strict';
