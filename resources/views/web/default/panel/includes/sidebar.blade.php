...
<div class="panel-sidebar pb-25 px-25" id="panelSidebar">
    <button class="btn-transparent panel-sidebar-close sidebarNavToggle">
        <i data-feather="x" width="24" height="24"></i>
    </button>

    <div class="text-center mb-20 mt-10">
        @if($authUser->branch_id == 3)
        <a href="/canada">
            <img src="/store/1/657400958cf84.png" alt="Logo" class="img-fluid" style="max-height:60px;">
        </a>
        @elseif($authUser->branch_id == 2)
        <a href="/uae">
            <img src="/store/1/657400958cf84.png" alt="Logo" class="img-fluid" style="max-height:60px;">
        </a>
        @elseif($authUser->branch_id == 4)
        <a href="/egy">
            <img src="/store/1/657400958cf84.png" alt="Logo" class="img-fluid" style="max-height:60px;">
        </a>
        @else
...
.panel-sidebar .sidebar-create-class .sidebar-create-class-btn img {
    ...
    @can('panel_others_logout')
        <li class="sidenav-item" style="margin: 10px 0;background: #ff2b2b;border-radius: 21px;padding: 6px;">
            <a href="/logout" class="d-flex align-items-center" style="justify-content: center;">
