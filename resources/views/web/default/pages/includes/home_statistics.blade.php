                ...
                <div class="row">
                    <div class=" mt-25 mt-lg-0">
                        <div class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100">
                            ...
                            <strong
                                class="stat-number mt-10">{{ $homeDefaultStatistics['skillfulTeachersCount'] }}</strong>
                ...
                <div class="row">
                    @foreach ($homeCustomStatistics as $homeCustomStatistic)
                        <div class="col-sm-6 col-lg-3 mt-25 mt-lg-0">
                            <div
                                class="stats-item d-flex flex-column align-items-center text-center py-30 px-5 w-100 rounded-2">
                                <div class="stat-icon-box d-flex justify-content-center align-items-center rounded-circle mb-3"
                                    style="background-color: {{ $homeCustomStatistic->color }}; width: 70px; height: 70px;">
                                    <img src="{{ $homeCustomStatistic->icon }}"
                                        alt="{{ $homeCustomStatistic->title }}" class="img-fluid"
