                ...
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="/ar/search/egy" method="get">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @foreach($featureWebinars as $featureWebinar)
                                <div class="swiper-slide">
                                    @include('web.default.includes.webinar.grid-card-egy',['webinar' => $featureWebinar->webinar])
                                </div>
                            @endforeach
                ...
                <div class="row mt-20">
                    <div class="col-12 col-lg-12">
                            ...
                            <div class="row">
                                @foreach($webinars as $webinar)
                                    <div class="col-12 col-lg-4 mt-20">
                                        @include('web.default.includes.webinar.grid-card-egy',['webinar' => $webinar])
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @elseif(!empty(request()->get('card')) and request()->get('card') == 'list')
                            ...
                            @foreach($webinars as $webinar)
                                @include('web.default.includes.webinar.canada.list-card-egy',['webinar' => $webinar])
                            @endforeach
                        @endif
