            ...
            <div class="row align-items-center">
                <div class="col-lg-4 d-flex align-items-center">
                    <div class="checkbox-button primary-selected">
                        <form action="{{ route('cet_courses_canada') }}" method="get">
            ...
            <div class="col-12 col-lg-12">
                ...
                <table class="table table-bordered table-hover table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="width:7rem;text-align: center;">{{trans('public.Price')}}<br>{{trans('public.canada')}}</th>
                ...
                @endswitch
                            ...
                            <td rowspan="{{ count($details) }}">
                                <a href="/{{ app()->getLocale() }}/course/details/canada/{{ $webinar->slug }}"class="btn btn-info btn-sm">{{ trans('public.details') }}</a>
                            </td>
                            @endif
                    @endforeach
                    @endforeach
