                ...
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="/en/search/canada" method="get">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @foreach($featureWebinars as $featureWebinar)
                                <div class="swiper-slide">
                                    @include('web.default.includes.webinar.grid-card_canada',['webinar' => $featureWebinar->webinar])
                                </div>
                            @endforeach
                ...
                <div class="row mt-20">
                    <div class="col-12 col-lg-12">
                            ...
                            <div class="row">
                                @foreach($webinars as $webinar)
                                    <div class="col-12 col-lg-4 mt-20">
                                        @include('web.default.includes.webinar.grid-card_canada',['webinar' => $webinar])
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @elseif(!empty(request()->get('card')) and request()->get('card') == 'list')
                            ...
                            @foreach($webinars as $webinar)
                                @include('web.default.includes.webinar.canada.list-card',['webinar' => $webinar])
                            @endforeach
                        @endif
