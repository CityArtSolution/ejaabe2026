                ...
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        ...
                        <div class="search-input bg-white p-10 flex-grow-1">
                            <form action="/ar/search/uae" method="get">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @foreach($featureWebinars as $featureWebinar)
                                <div class="swiper-slide">
                                    @include('web.default.includes.webinar.grid-card-uae',['webinar' => $featureWebinar->webinar])
                                </div>
                            @endforeach
                ...
                <div class="row mt-20">
                    <div class="col-12 col-lg-12">
                        ...
                        @elseif(!empty(request()->get('card')) and request()->get('card') == 'list')
                            ...
                            @foreach($webinars as $webinar)
                                @include('web.default.includes.webinar.canada.list-card-uae',['webinar' => $webinar])
                            @endforeach
                        @endif
