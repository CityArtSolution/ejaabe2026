                            ...
                            <div class="hero-content">
                                ...
                                <div class="hero-buttons">
                                    @if(!empty($slider->button1_title) && !empty($slider->button1_link))
                                        <a href="{{ $slider->button1_link }}" class="hero-btn hero-btn-primary"
                                           target="_blank">
                                    ...
                                    @if(!empty($slider->button2_title) && !empty($slider->button2_link))
                                        <a href="{{ $slider->button2_link }}" class="hero-btn hero-btn-secondary"
                                           target="_blank">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <span
                                                                    class="duration ml-5 text-dark-blue font-14">{{ convertMinutesToHourAndMinute($feature->webinar->duration) }} {{ trans('home.hours') }}</span>
                                                            </div>
                                                        ...
                                                        <div class="feature-price-box">
                                                            @if(!empty($feature->webinar->price ) and $feature->webinar->price > 0)
                                                                @if($feature->webinar->bestTicket() < $feature->webinar->price)
                                                                    <span
                                                                        class="real">{{ handlePrice($feature->webinar->bestTicket(), true, true, false, null, true, null) }} {{getBranchCurrency(3)}}</span>
                                                                @else
                                    ...
                                    <div
                                        ...
                                        <a href="{{ $organization->getProfileUrl() }}"
                                           class="mt-25 d-flex flex-column align-items-center justify-content-center">
                                            ...
                                            <span
                                                class="home-organizations-badge badge mt-15">{{ $organization->webinars_count }} {{ trans('panel.classes') }}</span>
                                        </a>
                                    </div>
                                </div>
                            @endforeach
    ...
    <div id="whatsapp_chat_widget">
        ...
        <div class="wa-chat-box-no-text" id="wa-chat-box-no-text" style="display: none;">
            <div class="wa-chat-box-header">
                <div class="wa-chat-box-brand-container">
                    <img class="wa-chat-box-brand"
                         onerror="this.src= &quot;https://widget.bot.space/images/BotSpaceLogoLight.png&quot;;"
                         src="public/uploads/main/images/09-12-2023/657400958cf84.png">
                ...
                <div class="wa-chat-bubble-close-btn" id="wa-chat-bubble-close-btn"
                     style="position: absolute;top: 15px;right: 13px;cursor:pointer"><img style="display: table-row"
                                                                                          src="https://widget.bot.space/images/close-icon.png">
                </div>
            </div>
            ...
            <div class="wa-chat-box-send">
                ...
                <div class="wa-chat-box-poweredby">⚡️ by <a href="https://bot.space/?ref=whatsappChatWidget"
                                                            target="_blank" style="color: #006eff6e;">bot.space</a>
                </div>
            </div>
        </div>
    </div>
