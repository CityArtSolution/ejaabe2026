    ...
    <div class="course-reviews-box row align-items-center">
        ...
        <div class="col-9">
            <div class="d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.What is your assessment of the availability of electronic services and the ease of obtaining them?') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('content_quality'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.Satisfaction with the platform and its tools') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('instructor_skills'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.Ease of use') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('purchase_worth'), 1) : 0 }})</span>
            </div>
            ...
            <div class="mt-25 d-flex align-items-center">
                ...
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.Satisfaction with the technical support services provided') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('support_quality'), 1) : 0 }})</span>
            </div>
            
            
               <div class="mt-25 d-flex align-items-center">
                <div class="progress course-progress rounded-sm">
                    <span class="progress-bar rounded-sm" style="width: {{ $course->reviews->avg('guides') / 5 * 100 }}%"></span>
                </div>
                <span class="ml-15 font-14 text-gray text-left">{{ trans('product.How useful are the guidelines?') }} ({{ $course->reviews->count() > 0 ? round($course->reviews->avg('guides'), 1) : 0 }})</span>
            </div>
...
<section class="mt-40">
    ...
    <form action="/reviews/store" class="mt-20" method="post">
        ...
        <div class="reviews-stars row align-items-center">
            ...
            <div class="col-6 col-md-4 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">{{ trans('product.What is your assessment of the availability of electronic services and the ease of obtaining them?') }}</span>
            ...
            <div class="col-6 col-md-4 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">{{ trans('product.Satisfaction with the platform and its tools') }}</span>
            ...
            <div class="col-6 col-md-4 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">{{ trans('product.Ease of use') }}</span>
            ...
            <div class="col-6 col-md-4 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">{{ trans('product.Satisfaction with the technical support services provided') }}</span>
            ...
            <div class="col-6 col-md-4 d-flex flex-column align-items-center justify-content-center barrating-stars">
                <span class="font-14 text-gray">{{ trans('product.How useful are the guidelines?') }}</span>
                <select name="guides" data-rate="1">
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                    <option value="4">4</option>
