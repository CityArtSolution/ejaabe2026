                    ...
                    <div class="row mt-5 cart-row">
                        ...
                        if (!empty($cart->webinar_id)) {
                            ...
                            @if(!empty($cartItemInfo['discountPrice']))
                                <span class="text-gray text-decoration-line-through mx-10 mx-md-0">{{ handlePrice($cartItemInfo['price']+$price , true, true, false, null, true, $cartTaxType) }}</span>
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold">{{ handlePrice($cartItemInfo['discountPrice']+$price , true, true, false, null, true, $cartTaxType) }}</span>
                            @else
                                <span class="font-20 text-primary mt-0 mt-md-5 font-weight-bold">{{ handlePrice($cartItemInfo['price']+$price, true, true, false, null, true, $cartTaxType) }}</span>
                            @endif
                    ...
                    <section class="mt-45">
                        ...
                        <div class="rounded-sm shadow mt-20 pb-20 px-20">
                            ...
                            <div class="cart-checkout-item">
                               ...
                               @endphp
                                 {{ number_format($discountedPrice+handlePrice($totalDiscount), 2) }}
