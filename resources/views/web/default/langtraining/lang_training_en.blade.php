                    ...
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="banner-three__content pt-0 pb-0">
                            ...
                            <p class="wow fadeInUp mt-20" data-wow-delay="400ms" data-wow-duration="1500ms"
                                ...
                                Our language training programs enhance communication skills and cultural understanding,
                                helping participants prepare for global opportunities.
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="section-header text-center mb-60">
                    <h3 class="wow fadeInUp arrow-heading" data-wow-delay="10ms" data-wow-duration="1500ms"
                        ...
                        Services Offered in Language Training Solutions
                    </h3>
                </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="5ms" data-wow-duration="1500ms">
                        <div class="process__item card border-0 shadow-hover h-100">
                            <div class="card-body text-left">
                                ...
                                <h4 class="mt-3 mb-3 text-primary">IELTS Preparatory Courses</h4>
                                <p class="text-muted">Comprehensive training in listening, reading, writing, and speaking.
                                </p>
                                <ul class="list-unstyled text-start">
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Reading:
                                        Understanding question types and answering strategies.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Listening:
                                        Recognizing question patterns and identifying key information.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Writing: Organizing
                                        ideas and writing clear, coherent essays.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Speaking:
                                        Practicing fluent responses with proper pronunciation.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="10ms" data-wow-duration="1500ms">
                        <div class="process__item card border-0 shadow-hover h-100">
                            <div class="card-body p-4 text-left">
                                ...
                                <h4 class="mt-3 mb-3 text-primary">Business Language and Conversation Courses</h4>
                                <p class="text-muted">Customized programs to meet professional and personal needs.</p>
                                <ul class="list-unstyled text-start">
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Developing
                                        conversation and communication skills in a business environment.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Learning business
                                        terminology and preparing reports and formal correspondence.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Improving
                                        negotiation skills, meeting skills, and presentation skills.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Training in
                                        effective communication via phone and email.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="15ms" data-wow-duration="1500ms">
                        <div class="process__item card border-0 shadow-hover h-100">
                            <div class="card-body p-4 text-left">
                                ...
                                <h4 class="mt-3 mb-3 text-primary">Official IELTS Test</h4>
                                <p class="text-muted">Certified by the British Council for both Academic and General
                                    Training tests.</p>
                                <ul class="list-unstyled text-start">
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Organizing Body:
                                        British Council.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Academic Test:
                                        For university studies and more.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>General Test: For
                                        immigration, work, or tourism.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Test Duration: 2
                                        hours and 45 minutes.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Online
                                        Registration.</li>
                                    <li class="mb-2"><i class="fas fa-check-circle text-green m-2"></i>Question Types:
                                        Multiple choice, sentence completion, essay writing, open-ended questions.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
