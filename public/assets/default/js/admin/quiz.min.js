...
(function ($) {
  ...
  $('body').on('click', '.edit_cat_question_eval', function (e) {
    e.preventDefault();
    var $this = $(this);
    var question_id = $this.attr('data-cat-question-id');
     
    loadingSwl();
    $.get(adminPanelPrefix + '/quizzes-questions/' + question_id + '/editcateval', function (result) {
      if (result && result.html) {
          
        var $html = '<div id="editCatQuestion">' + result.html + '</div>';
        Swal.fire({
          html: $html,
          showCancelButton: false,
          showConfirmButton: false,
  ...
  $('body').on('click', '.edit_question_eval', function (e) {
    e.preventDefault();
    var $this = $(this);
    var question_id = $this.attr('data-question-id');
    loadingSwl();
    $.get(adminPanelPrefix + '/quizzes-questions/' + question_id + '/editeval', function (result) {
      if (result && result.html) {
        var $html = '<div id="editQuestion">' + result.html + '</div>';
        Swal.fire({
          html: $html,
