...
Route::post('/webinars/{id}/toggle-homepage','WebinarController@toggleHomepage');

Route::get('/file-library', [FileLibraryController::class, 'index'])->name('file-library.index');
Route::post('/file-library/add', [FileLibraryController::class, 'store'])->name('file-library.store');
Route::post('/file-library/update/{id}', [FileLibraryController::class, 'update'])->name('file-library.update');
Route::delete('/file-library/delete/{id}', [FileLibraryController::class, 'destroy'])->name('file-library.destroy');
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'maincategories'], function () {
            ...
            Route::get('/{id}/edit', 'MainCategoryController@edit');
            Route::post('/{id}/update', 'MainCategoryController@update');
            Route::get('/{id}/delete', 'MainCategoryController@destroy');
            Route::post('/search', 'MainCategoryController@search');
 ...
 //get results of  quizes reports
     Route::get('/results', 'UserController@getResults');
     //get reports of eval
      Route::get('/{id}/eval', 'QuizController@evalResults');
      //reports
      
         Route::get('/showRequests', 'ReportsController@show_requests')->name('show_requests');
         Route::get('/evens-registrations-orders', 'ReportsController@events_orders')->name('events_orders');
         Route::get('/reveune-list', 'ReportsController@reveune_list')->name('reveune_list');

      Route::get('/course-statistics', 'ReportsController@course_statistics')->name('course_statistics');
      Route::get('/coursesreviews', 'ReportsController@courses_reviews')->name('courses_reviews');
        ...
        Route::group(['prefix' => 'webinars'], function () {
            ...
            Route::get('/create', 'WebinarController@create');
              //create exam
            Route::get('/create-exam', 'WebinarController@createExam');
          //create eval
            Route::get('/create-eval', 'WebinarController@createEval');
            Route::post('/store', 'WebinarController@store');
            Route::post('/store/scorm', 'WebinarController@store_scorm');
            
            Route::get('/{id}/edit', 'WebinarController@edit');
            Route::get('/{id}/copy', 'WebinarController@copyCourse');

            Route::post('/{id}/update', 'WebinarController@update');
            Route::post('/{id}/update/scorm/webinar', 'WebinarController@update_scorm');
            ...
            Route::group(['prefix' => 'features'], function () {
                ...
                Route::get('/scorm', 'WebinarController@create_scorm');
        ...
        Route::group(['prefix' => 'slider'], function () {
            Route::get('/', 'SliderController@index')->name('listslides');
            Route::get('/create', 'SliderController@create')->name('createslide');
            Route::post('/store', 'SliderController@store')->name('storeslide');
            Route::get('/{id}/edit', 'SliderController@edit')->name('editslide');
       ...
       Route::post('/{id}/update', 'BranchController@update')->name('branches.update');
       Route::get('/delete/{id}', 'BranchController@destroy')->name('branches.delete');
       Route::get('/changeBranch/{id}', 'BranchController@updateBranchSession')->name('branches.updateBranchSession');
         Route::get('/branches/clear-session','BranchController@clearBranchSession')->name('branches.clearBranchSession');
        });
                     //events
       ...
       Route::post('/{id}/update', 'EventController@update')->name('events.update');
       Route::get('/delete/{id}', 'EventController@destroy')->name('admin.events.delete');
        ...
        //import quizes questions from excel file    
         Route::post('/import', 'QuizQuestionController@import')->name('quiz-questions.import');
        ...
        Route::group(['prefix' => 'quizzes-questions'], function () {
            ...
            removeContentLocale();
             Route::get('/{id}/editeval', 'QuizQuestionController@editeval');
            Route::get('/{id}/editcateval', 'QuizQuestionController@editcateval');
            Route::post('/{id}/update', 'QuizQuestionController@update');
            Route::get('/{id}/delete', 'QuizQuestionController@destroy');
        });
        // eval category
         Route::group(['prefix' => 'evalcategory'], function () {
            Route::post('/store', 'EvalCategoriesController@store');
           
            Route::post('/{id}/update', 'EvalCategoriesController@update');
            Route::get('/{id}/delete', 'EvalCategoriesController@destroy');
        });
        ...
        Route::group(['prefix' => 'webinar-extra-description'], function () {
            ...
            Route::post('/delete-attachment','WebinarExtraDescriptionController@deleteAttachment')->name('webinar-extra-description.delete.attachment');
        ...
        Route::group(['prefix' => 'enrollments'], function () {
            ...
            Route::post('/store', 'EnrollmentController@store');
             //import and  enroll students from excel
            Route::post('/import', 'EnrollmentController@import');
