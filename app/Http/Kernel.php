...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'web.auth_canada' => \App\Http\Middleware\WebAuthenticateCanada::class,
        'web.auth_egy' => \App\Http\Middleware\WebAuthenticateEgy::class,
        'web.auth_uae' => \App\Http\Middleware\WebAuthenticateUae::class,
