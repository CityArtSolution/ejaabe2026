...
class SearchController extends Controller
{
    ...
    public function canada(Request $request)
    {
        ...
        return view(getTemplate() . '.pages.canada.search', $data);
    }
    public function egy(Request $request)
    {
        $data = [];
        ...
        return view(getTemplate() . '.pages.egypt.search', $data);
    }
    public function uae(Request $request)
    {
        ...
        return view(getTemplate() . '.pages.uae.search', $data);
    }
}
